...
// only cover-specific options need dedicated controls.
...
export const FIELD_GROUPS = Object.freeze([
	{ id: "source", label: "资源与谱面" }, { id: "visual", label: "画面与音频" }, { id: "game", label: "播放与用户" }, { id: "runtime", label: "渲染与 FFmpeg" }, { id: "cover", label: "封面生成" },
]);
export function fieldGroup(key) {
	if (["coverThemeImageX", "coverThemeImageY", "coverThemeImageWidth"].includes(key)) return "cover";
